                ...
                if (qpost.length!=0){
                    ...
                    query2.find({
                        success: function(results2) {
                            ...
                            $('#cf2-trg').click(function(){
                              $('#cf2').fadeIn();
                            });
                            $('#cpg-trg').click(function(){
                              $('#cmpg-form').fadeIn();
                            });
                        },
                        error: function(error2){
