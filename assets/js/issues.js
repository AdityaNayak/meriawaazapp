          ...
          success: function(results) {
                ...
                for (var i = 0; i < results.length; i++) { 
                    ...
                    if(object.get("type")=="comment"){
                        timelineView.append("<div class='row'><div class='small-2 columns wbg-fx'><img width='300' src='"+pphoto1+"' class='circle-img'></div><div class='small-10 columns'><div class='panel p-fx'><div class='panel-head'><strong>"+user.get("name")+"</strong> commented <small>"+ago+" ago</small></div><p>"+content+"</p></div></div></div>"); 
                    }
