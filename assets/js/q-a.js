    		...
    		for(var i=0;i<results.length;i++){
    			...
    			if(object.get("lastAnswer")!=undefined){
    				...
    				if(object.get("lastAnswer").get("pUser").get("pic")!=undefined){
	    				...
	    				if(object.get("lastAnswer").get("pUser").get("username")!=undefined){
			    ...
			    qView.append("<div class='row list-qa'><div class='small-9 columns' ><h4 id='question-"+questionId+"'>"+questionstatement+"</h4><div class='row'><div class='small-4 columns tertiary secondary-color'><i class='icon-clock secondary'></i> "+time+"</div><div class='small-4 columns tertiary secondary-color'><i class='icon-calendar secondary'></i> "+date+"</div><div class='small-4 columns tertiary secondary-color'><i class='icon-location secondary'></i> "+place+"</div></div><p class='s-ws-top'>"+questiondetails+"</p><p class='secondary-color secondary s-ws-top'> <strong>Last Reply: </strong>"+lastReply+"</p></div><div class='small-3 columns'><div class='s-ws-bottom secondary text-right'><i class='icon-close tertiary-color cs'></i></div><div class='row'><div class='small-6 columns text-center'><img src='"+askedbyPhoto+"' class='circle-img img-h'><div class='tertiary tertiary-color'>Asked by </div><div class='secondary-color secondary'>"+askedbyName+"</div></div><div class='small-6 columns text-center'><img src='"+ lastReplyPhoto+"' class='circle-img img-h'><div class='tertiary tertiary-color'>Last reply </div><div class='secondary-color secondary'>"+lastreplyName+"</div></div></div><div class='row'><div class='small-6 columns text-right s-ws-top'><span class='tertiary tertiary-color'>Last actvity:</span></div><div class='small-6 columns s-ws-top'><span class='secondary'>"+lastActivityTime+"</span></div></div><div class='row'><div class='small-6 columns text-right'><span class='tertiary-color tertiary'>Views:</div><div class='small-6 columns'><span class='secondary'>"+views+"</span></div></div><div class='row'><div class='small-6 columns text-right secondary-color'><span class='tertiary tertiary-color'>Comments:</span></div><div class='small-6 columns'><span class='secondary'>"+comments+"</div></div><div class='row'><div class='small-6 columns text-right secondary-color'><span class='tertiary-color tertiary'>Followers:</span></div><div class='small-6 columns'><span class='secondary'>"+followers+"</span></div></div></div></div><hr>");
 		...
 		success:function(results){
 			...
 			for(var i=0;i<results.length;i++){
			    ...
			    var answercontent=object.get("content");
 				...
 				$("#ans-view").append("<div class='row'><div class='small-3 columns text-right m-ws-top'><div class='row'>"+extraimage+"<div class='small-5 columns'><img src='"+photo+"' class='circle-img'></div></div><div class='row'><div class='small-12 columns tertiary secondary-color s-ws-top'><i class='icon-clock secondary tertiary-color'></i> "+time+"</div><div class='small-12 columns secondary-color tertiary'><i class='icon-calendar secondary tertiary-color'></i> "+date+"</div><div class='small-12 columns secondary-color tertiary'><i class='icon-location secondary tertiary-color'></i>"+place+"</div></div></div><div class='small-9 columns secondary-panel s-ws-top'><div class='text-right secondary'><i class='icon-close cs tertiary-color'></i></div><p class='s-ws-top'>"+answercontent+"</p><div class='tertiary s-ws-top secondary-color'>"+extratext+"</div></div></div>");
 			}
 			NProgress.done();
 		},
 		error: function(error){
